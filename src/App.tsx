            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="bg-blue-50">
                  <th className="border border-blue-100 p-3 text-gray-700 font-bold">Period</th>
                  <th className="border border-blue-100 p-3 text-blue-700 font-bold">Mon (월)</th>
                  <th className="border border-blue-100 p-3 text-blue-700 font-bold">Tue (화)</th>
                  <th className="border border-blue-100 p-3 text-blue-700 font-bold">Wed (수)</th>
                  <th className="border border-blue-100 p-3 text-blue-700 font-bold">Thu (목)</th>
                  <th className="border border-blue-100 p-3 text-blue-700 font-bold">Fri (금)</th>
                </tr>
              </thead>
              <tbody>
                {[
